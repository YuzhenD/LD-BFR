# LD-BFR
Our code is primarily developed based on https://github.com/CompVis/latent-diffusion. If there are any environment configuration issues, you can refer to related issues of LDM.
